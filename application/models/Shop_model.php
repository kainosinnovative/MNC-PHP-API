...
class Shop_model extends CI_Model
{
    ...
    {
        $sql = "SELECT a.*,b.services,b.combo_price,b.offer_percent,b.model_id, c.model_name FROM `shopinfo` a, combo_offers b, models c WHERE a.shop_id = b.shop_id and a.shop_id = '".$shopid."' and b.model_id= c.id order BY b.offer_percent DESC;";
		$query = $this->db->query($sql);
